<?php
/*
  $Id:bm_product_notifications.php$

  $Path: /catalog/includes/languages/dutch/modules/boxes/   $
...
*/
  ...
  define('MODULE_BOXES_PRODUCT_NOTIFICATIONS_DESCRIPTION',       'Toon artikelnieuwtjes op de artikelinformatiepagina');
