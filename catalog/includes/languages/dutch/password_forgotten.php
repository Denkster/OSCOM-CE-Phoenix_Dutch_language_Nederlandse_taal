...
define('TEXT_PASSWORD_RESET_INITIATED', 'U ontvangt van ons een e-mailbericht met instructies voor het veranderen van uw wachtwoord (controleer ook uw spambak). De instructies bevatten een link die vervalt na 24 uur en zodra u uw wachtwoord heeft veranderd.');

define('TEXT_NO_EMAIL_ADDRESS_FOUND',   'Let op: Wij vonden niemand met het e-mailadres dat u opgaf tussen onze klanten. Probeer het a.u.b. opnieuw');
...
define('ERROR_ACTION_RECORDER',         'Fout: Er is al een link voor een nieuw wachtwoord naar u gestuurd. Controleer uw inbox en uw spambak. Wacht a.u.b. %s minutes.');

define('IMAGE_BUTTON_RESET_PASSWORD',   'Wachtwoord opnieuw instellen');
