...
/*
  ...
  20190902 Denkster translated some forgotten items
*/
...
define('BOX_TOOLS_MAIL',                    'Stuur e-mail');
...
define('BOX_TOOLS_WHOS_ONLINE',             'Wie is er in de webshop?');
...
// javascript messages
define('JS_ERROR',                          'Er zijn fouten opgetreden tijdens het verwerken van uw invoer!\nVerbeter a.u.b. de volgende items:\n\n');

define('JS_OPTIONS_VALUE_PRICE',            '* Geef het nieuwe attribuut een prijs\n');
define('JS_OPTIONS_VALUE_PRICE_PREFIX',     '* Geef het nieuwe attribuut een voorteken (+ of -)\n');

define('JS_PRODUCTS_NAME',                  '* Geef het nieuwe artikel een naam\n');
define('JS_PRODUCTS_DESCRIPTION',           '* Geef het nieuwe artikel een beschrijving\n');
define('JS_PRODUCTS_PRICE',                 '* Geef het nieuwe artikel een prijs\n');
define('JS_PRODUCTS_WEIGHT',                '* Geef het nieuwe artikel een gewicht in grammen\n');
define('JS_PRODUCTS_QUANTITY',              '* Geef het aantal dat beschikbaar is op voor het nieuwe artikel\n');
define('JS_PRODUCTS_MODEL',                 '* Geef het model op voor het nieuwe artikel\n');
define('JS_PRODUCTS_IMAGE',                 '* Geef een afbeelding op voor het nieuwe artikel\n');

define('JS_SPECIALS_PRODUCTS_PRICE',        '* U moet een nieuwe waarde invullen bij de prijs voor dit artikel\n');

define('JS_GENDER',                         '* U moet een waarde kiezen bij \'Man of vrouw\'.\n');
define('JS_FIRST_NAME',                     '* U moet bij \'Voornaam of -letters\' tenminste ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' tekens invullen.\n');
define('JS_LAST_NAME',                      '* U moet bij \'Achternaam\' tenminste ' . ENTRY_LAST_NAME_MIN_LENGTH . ' tekens invullen.\n');
define('JS_DOB',                            '* Vul de \'Geboortedatum\' als volgt in: dd-mm-jjjj (dag-maand-jaar).\n');
define('JS_EMAIL_ADDRESS',                  '* U moet bij \'E-mail Adres\' tenminste ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' tekens invullen.\n');
define('JS_ADDRESS',                        '* U moet bij \'Straatnaam\' tenminste ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' tekens invullen.\n');
define('JS_POST_CODE',                      '* U moet bij \'Postcode\' tenminste ' . ENTRY_POSTCODE_MIN_LENGTH . ' tekens invullen.\n');
define('JS_CITY',                           '* U moet bij \'City\' tenminste ' . ENTRY_CITY_MIN_LENGTH . ' characters.\n');
define('JS_STATE',                          '* U moet bij \'State\' een waarde kiezen uit het uittrekmenu.\n');
define('JS_STATE_SELECT',                   '-- Kies uit de lijst --');
define('JS_ZONE',                           '* U moet bij \'Staat of provincie\' een waarde kiezen uit het uittrekmenu.');
define('JS_COUNTRY',                        '* U moet bij \'Land\' een waarde kiezen uit het uittrekmenu.\n');
define('JS_TELEPHONE',                      '* U moet bij \'Telefoonnummer\' tenminste ' . ENTRY_TELEPHONE_MIN_LENGTH . ' tekens invullen.\n');
define('JS_PASSWORD',                       '* U moet bij \'Wachtwoord\' en \'Bevestig\' tenminste ' . ENTRY_PASSWORD_MIN_LENGTH . ' tekens invullen.\n');

define('JS_ORDER_DOES_NOT_EXIST',           'Bestelnummer %s niet gevonden!');
...
// bootstrap helper
define('MODULE_CONTENT_BOOTSTRAP_ROW_DESCRIPTION', '<p>Geef de breedte de kolom aan met een geheel getal van 1 tot 12.</p><p>12/12 = 100% van de beschikbare breedte, 6/12 = 50% breedte, 4/12 = 33% breedte.</p><p>Het totaal van alle kolommen in elke rij moet gelijk zijn aan 12 (b.v.:  3 boxen van elk 4 kolommen, 1 box van 12 kolommen enz.).</p>');

// seo helper
define('PLACEHOLDER_COMMA_SEPARATION',      'Moet, door, kommas, gescheiden, zijn');
