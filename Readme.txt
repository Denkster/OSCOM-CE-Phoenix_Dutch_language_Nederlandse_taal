...
- Maak een bestand met algemene voorwaarden van uw webshop.
  ...
  Nederlandse wetten voor verkoop aan consumenten, zoals 'kopen op afstand'.
- Sla het bestand met uw voorwaarden op onder de naam alg_voorw_A5﻿﻿﻿﻿.pdf
- Kopieer het bestand alg_voorw_A5﻿﻿﻿﻿.pdf naar de map pub op uw server.
...
- Save the file with the name alg_voorw_A5﻿﻿﻿﻿.pdf.
- Copy the file alg_voorw_A5﻿﻿﻿﻿.pdf naar de map pub on your server.